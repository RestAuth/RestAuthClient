# -*- coding: utf-8 -*-
#
# RestAuthClient documentation build configuration file, created by
# sphinx-quickstart on Mon Jun  6 13:54:19 2011.
#
...
version = os.environ.get('RELEASE', LATEST_RELEASE)
...
htmlhelp_basename = 'RestAuthClientdoc'
...
latex_documents = [
  ('index', 'RestAuthClient.tex', u'RestAuthClient Documentation',
...
man_pages = [
    ('index', 'restauthclient', u'RestAuthClient Documentation',
     [u'Mathias Ertl'], 1)
]
