...
:doc:`user <user>` module, the module contains factory methods (:py:meth:`~.Group.get`,
...
performance is critical. Please see the :doc:`user <user>` module for an analogous
example.
